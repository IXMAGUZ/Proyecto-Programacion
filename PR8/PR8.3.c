...
void F2 (paciente A[], int T)
{
    ...
    printf("\nNumero de paciente en condicion 1: %d", C1);
    printf("\nNumero de paciente en condicion 2: %d", C2);
    printf("\nNumero de paciente en condicion 3: %d", C3);
    printf("\nNumero de paciente en condicion 4: %d", C4);
    printf("\nNumero de paciente en condicion 5: %d", C5);
}
