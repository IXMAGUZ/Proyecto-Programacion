...
#include <string.h>
/*Estructuras-2
El programa mustra la manera en que se declara una estuctura, asi como la forma\
en que se tiene acceso a los campos de los apuntadores de tipo estructura
tanto para la lectura como para la escritura. Se utiliza ademas una funcion que
recibe como parametros un apuntador de tipo estructura.*/
struct alumno
{
    int matricula;
    char nombre[20];
...
void main(void)
{
    ...
    printf("\nDatos del alumno 5\n");
    printf("%d\t%s\t%s\t%f\t%s", a5->matricula, a4->nombre, a5->carrera, a5->promedio, a5->direccion);
