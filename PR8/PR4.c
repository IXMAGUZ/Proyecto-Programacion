...
#include <string.h>
/*Bienes raices.
El programa maneja informacion sobre las propiedades que tiene una empresa de 
bienes raices de la ciudad de Lima, Peru, tanto para venta como para
renta.*/
typedef struct 
{
    char zona[20];
...
void Lectura(propiedades A[], int T)
{
    ...
    for ( I = 0; I < T; I++)
    {
        printf("\n\tIngrese datos de la propiedades %d", I + 1);
        printf("\nClave: ");
        fflush(stdin);
        gets(A[I].clave);
