#include <stdio.h>
/*Mezcla.
El programa mezcla, respetando el orden, dor archivos que se encuentran 
ordenados en forma ascendente considerado la matricula de los alumnos.*/
